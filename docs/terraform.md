...
| <a name="input_authenticated_listener_arns_count"></a> [authenticated\_listener\_arns\_count](#input\_authenticated\_listener\_arns\_count) | Count | `list(string)` | `[]` | no |
...
| <a name="input_unauthenticated_listener_arns_count"></a> [unauthenticated\_listener\_arns\_count](#input\_unauthenticated\_listener\_arns\_count) | Count | `list(string)` | `[]` | no |
